...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarToggler = function () {
        ...
        $(document).delegate('.dropdown-quick-sidebar-toggler a, .page-quick-sidebar-toggler, .quick-sidebar-toggler', 'click', function(e){
    ...
    var handleQuickSidebarChat = function () {
        ...
        var wrapperChatForm = wrapper.find('.page-quick-sidebar-chat-user-form');
        ...
        var initChatSlimScroll = function () {
            ...
            chatMessages.attr("data-height", '735');
        ...
        wrapper.find('.page-quick-sidebar-chat-users .media-list > .media').click(function(){
            ...
            var badge = $(this).find('.unreadMessageFrom').text('0').hide();
            $.ajax({
                type: 'GET',
                url: globalBaseUrl + '/chat/loadconversationwith/'+recipient,
                success: function (response) {
                    $('#loadMessagesTo').html(response.messages);
                    $('#loadFormTo').html(response.form);
                    $('#loadEarlierMessagesFormTo').html(response.formEarlier);
                    wrapperChatForm.find('input[name="text"]').focus();
